            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li>
                            <a href="${pageContext.request.contextPath}/showRegist" >注册</a>
                        </li>
                        <li class="userName">
                            您好：user！
                        </li>
                        ...
                        <div class="panel clear-panel">
                            <div class="panel-body">
                                <div class="art-back clear-back">
                                    ...
                                    <h4><a href="">小脚裤套装</a></h4>
                                    <div class="user clearfix pull-right">
                                        ￥49.00
                                    </div>
                                    <div class="desc">
                                        新款大毛领加绒加厚牛仔棉衣羊羔毛短外套 休闲 时尚 百搭
                                    </div>
                                    <div class="attention pull-right">
                                        加入购物车 <i class="icon iconfont icon-gouwuche"></i>
                                    </div>
                        ...
                        <div class="panel clear-panel">
                            <div class="panel-body">
                                <div class="art-back clear-back">
                                    ...
                                    <h4><a href="">高腰牛仔裤三件套</a></h4>
                                    <div class="user clearfix pull-right">
                                        ￥210.00
                                    </div>
                                    <div class="desc">
                                        这款棉马甲推荐给妹子们，立领的设计， 马甲款式，面料是比较好的羽绒棉， 上身软软的很舒服~单排扣金属衣门襟， 两个插袋设计，实用又比较保暖~ 经典百搭的颜色色，里面配卫衣或者毛衣，都灰常好看~
                                    </div>
                                    <div class="attention pull-right">
                                        加入购物车 <i class="icon iconfont icon-gouwuche"></i>
                                    </div>
                        ...
                        <div class="panel clear-panel">
                            <div class="panel-body">
                                <div class="art-back clear-back">
                                    ...
                                    <h4><a href="">仿皮草短款外套</a></h4>
                                    <div class="user clearfix pull-right">
                                        ￥210.00
                                    </div>
                                    <div class="desc">
                                        颜色无色差，质感好，百搭 2017冬季新款小香风淑女韩东大门女装毛毛外套
                                    </div>
                                    <div class="attention pull-right">
                                        加入购物车 <i class="icon iconfont icon-gouwuche"></i>
                                    </div>
                        ...
                        <div class="panel clear-panel">
                            <div class="panel-body">
                                <div class="art-back clear-back">
                                    ...
                                    <div class="desc">
                                        加绒保暖塑身，效果很好哦，告别臃肿的体态，买一件修正身形的内衣背心很有必要，关键价格白菜
                                    </div>
                                    <div class="attention pull-right">
                                        加入购物车 <i class="icon iconfont icon-gouwuche"></i>
                                    </div>
    ...
    <div class="modal fade" id="loginModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-content" id="login-account">
                ...
                <form action="${pageContext.request.contextPath}/user/login" class="form-horizontal" method="post">
                    <div class="modal-body">
                        <div class="form-group">
                    ...
                    <div class="modal-footer" style="text-align: center">
                        ...
                        <button type="button" class="btn btn-warning" data-dismiss="modal" aria-label="Close">关&nbsp;&nbsp;闭</button>
                        <button type="submit" class="btn btn-warning" onclick="userLogin()">登&nbsp;&nbsp;陆</button> &nbsp;&nbsp;
